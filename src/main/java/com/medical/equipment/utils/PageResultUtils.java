...
public class PageResultUtils implements Serializable {
    ...
    private static final long serialVersionUID = -789504940837869159L;
    /**
     * 总记录数
     */
     ...
     * @param currPage   当前页数
     */
    public PageResultUtils(List<?> list, int totalCount, int pageSize, int currPage) {
        this.list = list;
     ...
     * @param pageInfo
     */
    public PageResultUtils(PageInfo<?> pageInfo) {
